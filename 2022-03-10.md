...
- Groups migration
  ...
  - Support overview.md and logo.png
    ...
    - CLI
      commands?
        nextstrain group {name} logo download
        nextstrain group {name} logo upload {filename}
        nextstrain group {name} overview upload {filename}
    ...
    - API
      ...
      - Get member of a role
        GET /groups/:groupName/~/roles/:roleName/members/:username
          what does this return? would be metadata like "created_at" or
          similar, or who added the user to the role.
